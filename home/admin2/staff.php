        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                            ...
                            <div class="table-responsive">
                                ...
                                <?php 
                                 ...
                                 while($row =mysqli_fetch_array($ans)){
                                    ...
                                    <tbody>
                                        <tr>
                                            <td data-href='staff.php?id =$id' style='width:1%'>$id</td>
                                            <td data-href='staff.php?id =$id' style='width:35%'>$staff_name</td>
                                            <td data-href='staff.php?id =$id' style='width:22%'>$role</td>
                                            <td data-href='staff.php?id =$id' style='width:20%'>$qualification</td>
                                            <td data-href='staff.php?id =$id' style='width:21%'>$contact</td>
                                            <td style='width:1%'>
                                            <span style='margin-left:20%'>

                            <a href='staff.php?delete= ".$row['id']." '  data-toggle='modal' data-target='#product_view".$row['id']."' style='text-decoration:none'> 
                  ...
                  <a href='staff.php?update =".$row['id']."'
