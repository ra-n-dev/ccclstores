  ...
  /*
    ...
    */
    ...
    $ssum =mysqli_num_rows($rst);
     ...
     $quer ="SELECT count(ex_id) FROM expenditure_table WHERE request_date BETWEEN '$first' AND '$last' AND request_status ='pending' ";
     $reess =mysqli_query($connect, $quer);
     $raw =mysqli_fetch_array($reess);

     $ab="$monthlysales,$yearlysales,$roww[0],$raw[0],$raaw[0],$patients[0]";
  echo "$ab";
  echo "$patients";
