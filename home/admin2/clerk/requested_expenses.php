...
// getting the monthly drugs expenses
   ...
   //$monthly_net =$sum - $month_expenses
     ...
     if(isset($_GET['approve'])){
               $exp_date =date('Y-m-d');
               $id =$_GET['approve'];
               $que ="UPDATE expenditure_table SET request_status ='approved',expense_date='$exp_date',accountant_name='$uname' WHERE ex_id ='$id' ";
               $resultt = mysqli_query($connect,$que) ;

               
             echo "<script>window.location.href='../clerk/requested_expenses.php'</script>";
 }
 ...
 if (isset($_GET['reject'])){
               ...
               $idd =$_GET['reject'];
               $que ="UPDATE expenditure_table SET request_status ='rejected' WHERE ex_id ='$idd' ";
               $resultt = mysqli_query($connect,$que) ;
