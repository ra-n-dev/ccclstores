...
<div class="container-fluid">
 ...
 <main class="col-md-9 ms-sm-auto col-lg-10 " id="income_schedule" style=" width:100%">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h5 class="tees">Cash Book</h5>
        ...
        <div class="row" style="margin-left:0.2%;margin-bottom: 2%;">
            <div class="card border-left-primary shadow h-100 py-2 studdlist">
                ...
                <?php 
                 ...
                 $ser = "SELECT * FROM billsheet WHERE caseid_status='expired' AND datebilled BETWEEN '$startdate2' AND '$enddate2' ";
                   ...
                   echo "<thead>
                     ...
                     <thead>
                      <tr>
                       ...
                       $serr = "SELECT * FROM expenditure_table WHERE request_status='approved' AND expense_date BETWEEN '$startdate2' AND '$enddate2' ";
                       $resultt =mysqli_query($connect, $serr);
                  ...
                  $bal =$cum-$cumm;
                   echo "<thead>
                            <tr>
                                ...
                                <th scope='col'></th>
                                <th scope='col'>Total</th>
                                <th scope='col'>GHC $total_expenses</th>
                                <th scope='col'>GHC $cumm</th>
                            </tr>
                        </thead>";
