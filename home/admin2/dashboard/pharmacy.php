...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h5 class="tees">Drugs List</h5>
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
                <button type="button" class="btn btn-sm btn-outline-secondary" data-toggle="modal" data-target="#inventory">New</button>
            </div>
                ...
                echo"<table class='table table-bordered' id='example' width='100%' cellspacing='0' table-striped table-sm>
                 ...
                 echo"</tbody";        
                  ...
                  $query ="SELECT * FROM pharmacyinventory" ;
                      ...
                      <thead>
                      <tr >
                         <th style='width:20%' >Purchased Date</th>
                         <th style='width:30%' >Drug-Name</th>
                         <th style='width:25%' >Supplier</th>
                         <th style='width:25%' >Category</th>
                         <th style='width:25%' >Quantity</th>
                         <th style='width:25%' >Dosage(Ml/Mg)</th>
                    ...
                    if(mysqli_num_rows($result)<1){
                     ...
                     while ($row= mysqli_fetch_array($result)) {
                       ...
                       echo"<tbody>";
                       echo "<tr>
                       <td style=' padding-left:5px;padding-right:5px; width:25% '>$purchaseddate</td> 
                       <td style=' padding-left:5px;padding-right:5px; width:20%'>$drugname</td>
                        <td style='padding-left:5px;padding-right:5px; width:30% '>$supplier</td>
                        <td style=' padding-left:5px;padding-right:5px;width:25% '>$category</td>
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$quantity</td>
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$capacity</td> 
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$costprice</td> 
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$sellingprice</td> 
                        <td style=' padding-left:5px;padding-right:5px; width:25% '>$expirydate</td>
