...
$pay ="select date_format(datebilled,'%Y-%m'),sum(total_income) from billsheet WHERE caseid_status='expired' AND datebilled BETWEEN '$ma1' AND '$ma2' group by date_format(datebilled,'%Y-%m')";
 ...
 $date_income =[];
  ...
  while($row =mysqli_fetch_array($resulted)){
    $date1 =$row["date_format(datebilled,'%Y-%m')"];
    $incom =$row["sum(total_income)"];
...
// getting the monthly drugs expenses
   ...
   //$monthly_net =$sum - $month_expenses
    ...
    if($rez){
        echo "alert('Salary for $staffname has been paid successfully')";
    }else{
        echo "alert(There was a problem paying $staffname's Salary)";
    }
...
if(isset($_POST['medstock'])){
  ...
  echo'<script>window.location.href= "medicalstock.php "</script>';
  
}
if(isset($_POST['nonmedstock'])){
  $startdate1 = $_POST['startdate1'];
  $enddate1 = $_POST['enddate1'];
  $_SESSION['date1'] = $startdate1;
  $_SESSION['date2'] = $enddate1;
  
  echo'<script>window.location.href= "nonmedicalstock.php "</script>';
...
if(isset($_POST['id'])){
    $drugcat =$_POST['id'];
    $quer ="SELECT * FROM pharmacyinventory WHERE category = '$drugcat' ";
                        ...
                        <li class="nav-item doit">
                            ...
                            <div class="dropdown" style="width:100%; background: transparent;">
                                ...
                                <ul class="dropdown-menu menuu">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#cash">
                                        <li id="wok"><i data-feather="file" id="aaa"></i>cash book</li>
                                    </a>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#medstock">
                                        <li id="wok"><i data-feather="file" id="aaa"></i>Medical Stock</li>
                                    </a>
                                    <a href="#" data-toggle="modal" data-target="#nonmedstock">
                                        <li id="wok"><i data-feather="file" id="aaa"></i>Non Medical Stock</li>
                                    </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                External-Income(Monthly)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="other"></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0  font-weight-bold text-gray-800" id="ex_id"></div>
                                        </div>
