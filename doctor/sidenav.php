...
<body>
  ...
  <div class="side-bar">
      <div class=" hms"><h4 style="font-weight: bold;">Clinic Management System</h4></div>
      <div class="logo">
          <img src="../image/cccl4.png" alt="image is required">
      </div>
      <div class="menu">
          <div class="item"><a id="myHref" href=""><i class="fas fa-desktop"></i>Dashboard</a></div>
          ...
          <div class="item"><a href="form1.php"><i class="fas fa-book-open"></i>Report</a></div>
...
<script>
  ...
  window.history.pushState('new','title','index.php');
});
